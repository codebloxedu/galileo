...
import { LottieLayer } from '../components/Examples/Lottie-Framer/Lottie-Framer.js';
...
let homeHeader = new Layer({
	image:'assets/codebloxheader.png',
	y: prototypeHeight / 6, 
	width: 195, height: 38,
	parent: homescreen
});
...
let textScrollValue = new Layer({
	...
	width: 100,
	backgroundColor: null,
	color: CodebloxUI.Colors.TextPrimary,
	parent: demoAPanel,
});
...
optionE.onClick(()=>{
	Examples.showNext(sectionMicroInteraction);
})
